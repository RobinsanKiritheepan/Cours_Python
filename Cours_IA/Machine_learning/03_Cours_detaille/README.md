...
| Dossier | Contenu |
|---|---|
| **[Corrections_expliquees](Corrections_expliquees/)** | Les corrections du cours, également annotées |

> ⚠️ Le **code est identique** aux exercices originaux — seules des cellules markdown ont
> été ajoutées. Les erreurs du code d'origine sont **expliquées, pas corrigées** (les versions
> corrigées sont dans [`04_Notebooks_solutions_perso`](../04_Notebooks_solutions_perso/)).
